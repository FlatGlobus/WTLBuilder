...
void CSortListViewCtrl::InitProperty(void)
{
	...
	DEFINE_PROPERTY(AutoArrange,BOOL,CSortListViewCtrl,FALSE)
	DEFINE_PROPERTY(EditLabels,BOOL,CSortListViewCtrl,FALSE)
	DEFINE_PROPERTY(NoColumnHeader,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(NoLabelWrap,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(NoScroll,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(NoSortHeader,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(OwnerData,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(OwnerDrawFixed,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(ShareImageLists,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(ShowSelAlways,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(SingleSel,BOOL,CSortListViewCtrl,FALSE)	
	DEFINE_PROPERTY(ListStyle,ListViewStyle,CSortListViewCtrl,LVS_LIST)
	DEFINE_PROPERTY(Alignment,ListAlignStyle,CSortListViewCtrl,LVS_ALIGNTOP)
	DEFINE_PROPERTY(Sort,ListSortStyle,CSortListViewCtrl,0)
		///common styles
	DEFINE_PROPERTY(NoDivider,BOOL,CSortListViewCtrl,FALSE)
	DEFINE_PROPERTY(NoMoveY,BOOL,CSortListViewCtrl,FALSE)
	DEFINE_PROPERTY(NoParentAlign,BOOL,CSortListViewCtrl,FALSE)
	DEFINE_PROPERTY(NoResize,BOOL,CSortListViewCtrl,FALSE)
	PUBLIC_PROPERTY(VScroll,TRUE)
	PUBLIC_PROPERTY(HScroll,TRUE)

    DEFINE_PROPERTY(CheckBoxes,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(GridLines,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(SubItemImages,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(TrackSelect,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(HeaderDragAndDrop,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(FullRowSelect,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(OneClickActivate,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(TwoClickActivate,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(FlatSB,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(Regional,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(InfoTip,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(UnderLineHot,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(UnderLineCold,BOOL,CSortListViewCtrl,FALSE)
    DEFINE_PROPERTY(MultiWorkAreas,BOOL,CSortListViewCtrl,FALSE)
