...
#ifndef __SORTLISTVIEWCTRL_H
#define __SORTLISTVIEWCTRL_H
//////////////////////////////////////////////////////////////////////////
...
#define IMPLEMENT_LISTVIEWEXSTYLE_BOOL_PROPERTY(Class,Name,Style)\
	...
	class CSortListViewCtrl:public CWindowImpl<CSortListViewCtrl,WTL::CListViewCtrl>,public ControlComponent<CSortListViewCtrl>
	{
        CString listItemClass; 
	public:
		CSortListViewCtrl(LPTSTR _name=NULL);
		~CSortListViewCtrl(void);
		virtual BOOL CreateComponent(Component *);
		BEGIN_MSG_MAP(CSortListViewCtrl)
			CHAIN_MSG_MAP(ControlComponent<CSortListViewCtrl>)
        ...
        DECLARE_PROPERTY(ItemClass,CString)	
