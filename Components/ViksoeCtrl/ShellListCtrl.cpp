    ...
    void CShellListCtrlComp::InitProperty(void)
    {
        ...
        DEFINE_PROPERTY(AutoArrange,BOOL,CShellListCtrlComp,FALSE)
			...
			BEGIN_SUB_PROPERTY(_T("ControlStyle"), _T(""))
				DEFINE_SUB_PROPERTY(CheckBoxes,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(GridLines,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(SubItemImages,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(TrackSelect,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(HeaderDragAndDrop,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(FullRowSelect,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(OneClickActivate,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(TwoClickActivate,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(FlatSB,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(Regional,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(InfoTip,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(UnderLineHot,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(UnderLineCold,BOOL,CShellListCtrlComp,FALSE)
				DEFINE_SUB_PROPERTY(MultiWorkAreas,BOOL,CShellListCtrlComp,FALSE)
			END_SUB_PROPERTY
