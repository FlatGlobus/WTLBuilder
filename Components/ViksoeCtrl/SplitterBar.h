...
{
	class CVertSplitterCtrlComp:public CVertSplitterCtrl,public ControlComponent<CVertSplitterCtrlComp>
	{
        CString leftPane,rightPane;
        Component *leftPaneWnd,*rightPaneWnd;
        BOOL CheckPaneName(CString str);
	public:
		CVertSplitterCtrlComp(char * _name);
		~CVertSplitterCtrlComp(void);
		
		BEGIN_MSG_MAP(CVertSplitterCtrlComp)
			CHAIN_MSG_MAP(ControlComponent<CVertSplitterCtrlComp>)
			CHAIN_MSG_MAP(CVertSplitterCtrl)
		END_MSG_MAP()
