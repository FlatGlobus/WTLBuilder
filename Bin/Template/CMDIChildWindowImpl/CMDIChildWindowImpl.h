...
//}}WTLBUILDER_WINDOW_STYLE
class [!CLASSNAME]:public CMDIChildWindowImpl<[!CLASSNAME],CWindow,[!CLASSNAME]WinTraits>,
...
public:
	...
	typedef CMDIChildWindowImpl<[!CLASSNAME], CWindow, [!CLASSNAME]WinTraits>	thisClass;
